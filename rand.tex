...
\resumeSubHeadingListStart
  \resumeSubheading
    ...
    \resumeItemListStart
      \resumeItem{Developed and maintained scalable microservices to support new product features and client requirements}
      \resumeItem{Collaborated on the development and maintenance of production code deployed to clients}
      \resumeItem{Conducted comprehensive QA testing to ensure feature reliability and performance}
      \resumeItem{Identified and resolved bugs to enhance system stability}
    \resumeItemListEnd
  \resumeSubheading
